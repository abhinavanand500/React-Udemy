                ...
                <div className='row'>
                    <div className='col-md-6 col-10 mx-auto'>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" className="form-control" id="exampleFormControlInput3" placeholder="+918095509320" />
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput4" className="form-label">Address</label>
                            <input type="text" className="form-control" id="exampleFormControlInput4" placeholder="Enter your address" />
                        </div>
                        <div className="mb-3">
                        ...
                        <hr />
                        <button type="button" className="btn btn-outline-success text-center">Submit</button>
                    </div>
                </div>
            </div>
        </>
